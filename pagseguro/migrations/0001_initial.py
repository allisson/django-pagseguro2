        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        help_text=b"C\xc3\xb3digo gerado para redirecionamento.",
                        max_length=100,
                ...
                (
                    ...
                    models.DateTimeField(
                        help_text=b"Data em que o checkout foi realizado.", verbose_name=b"Data"
                    ),
                ),
                (
                    "success",
                    models.BooleanField(
                        help_text=b"O checkout foi feito com sucesso?", db_index=True, verbose_name=b"Sucesso"
                    ),
                ),
                (
                    "message",
                    models.TextField(
                        help_text=b"Mensagem apresentada no caso de erro no checkout.",
                        verbose_name=b"Mensagem de erro",
                        blank=True,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateTimeField(
                        help_text=b"Data em que a transa\xc3\xa7\xc3\xa3o foi criada.", verbose_name=b"Data"
                    ),
                ),
                (
                    "last_event_date",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        help_text=b"Status da transa\xc3\xa7\xc3\xa3o.",
                        max_length=20,
                        verbose_name=b"Status",
                        choices=[
                            (b"aguardando", b"Aguardando"),
